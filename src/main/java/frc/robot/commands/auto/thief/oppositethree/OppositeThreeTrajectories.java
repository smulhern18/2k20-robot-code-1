...
public final class OppositeThreeTrajectories extends Trajectories {
  private static final Pose2d SHOOT_START = new Pose2d(10.188, -4.545, new Rotation2d(Units.degreesToRadians(-68.20)));
  public static final Trajectory OPPOSITE_THREE_GRAB = TrajectoryGenerator.generateTrajectory(
      List.of(
          ...
          new Pose2d(6.824, -5.621, new Rotation2d(Units.degreesToRadians(46.11))),
